...
def createRecordForSetting(setting: str) -> bool:
    ...
    if setting == "ShapeNet_NonUniform_MASH":
        recordMetrics(
            dataset_root_path + "ShapeNet/manifold/",
            dataset_root_path
            + "ShapeNet/manifold_mash-4096_random-10_noise-0-002-400anc/",
            ".obj",
            ".npy",
            "mash",
            save_metric_file_path,
    ...
    if setting == "ShapeNet_NonUniform_2048_MASH":
        recordMetrics(
            ...
            dataset_root_path
            + "ShapeNet/manifold_mash-2048_random-10-400anc/03001627/",
            ".obj",
            ".npy",
            "mash",
            save_metric_file_path,
    ...
    if setting == "ShapeNet_NonUniform_2048_MASH-100anc":
        recordMetrics(
            dataset_root_path + "ShapeNet/manifold_test/",
            dataset_root_path
            + "ShapeNet/manifold_mash-2048_random-10-100anc/03001627/",
            ".obj",
            ".npy",
            "mash",
            save_metric_file_path,
    ...
    if setting == "ShapeNet_NonUniform_1024_MASH":
        recordMetrics(
            dataset_root_path + "ShapeNet/manifold_test/",
            dataset_root_path
            + "ShapeNet/manifold_mash-1024_random-10-400anc/03001627/",
            ".obj",
            ".npy",
            "mash",
            save_metric_file_path,
