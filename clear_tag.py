...
if __name__ == "__main__":
    ...
    if clear_tag:
        ...
        clearTag(
            dataset_root_folder_path + "Objaverse_82K/render_dino/",
            ".npy",
            dry_run,
            worker_num,
        )
        clearTag(
            dataset_root_folder_path + "Objaverse_82K/manifold_sdf_0_25/",
            ".npy",
            dry_run,
            worker_num,
        )
    ...
    if remove_invalid_npy:
        removeInvalidPNG(
            dataset_root_folder_path + "Objaverse_82K/render/", dry_run, worker_num
        )
        removeInvalidNPY(
            dataset_root_folder_path + "Objaverse_82K/render_dino/", dry_run, worker_num
        )
