...
if __name__ == "__main__":
    ...
    while True:
        ...
        #demo_convert_mash(400, 'ShapeNet/manifold_pcd-2048_random-10/', 'ShapeNet/manifold_mash-2048_random-10-400anc/')
        #demo_convert_mash(400, 'ShapeNet/manifold_pcd-1024_random-10/', 'ShapeNet/manifold_mash-1024_random-10-400anc/')
        #demo_convert_mash(100, 'ShapeNet/manifold_pcd-2048_random-10/', 'ShapeNet/manifold_mash-2048_random-10-100anc/')
        #demo_convert_mash(50, 'ShapeNet/manifold_pcd-1024_random-10/', 'ShapeNet/manifold_mash-1024_random-10-50anc/')
