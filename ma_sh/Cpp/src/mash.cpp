...
const torch::Tensor toMashSamplePoints(
  ...
  toInMaxMaskThetas(mask_params, sample_base_values,
                    in_max_mask_sample_polar_idxs,
                    in_max_mask_sample_polar_data_idxs, in_max_mask_base_values,
                    in_max_mask_thetas);
