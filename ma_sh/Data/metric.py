...
ShapeNet_Data = [
    ...
    ['$S_{cos}$\\uparrow', '0.684', '0.974', '0.821', '0.898', '0.980', '0.984\\bf', '0.950', '0.991'],
...
ShapeNet_NonUniform_8192_Data = [
    ...
    ['$S_{cos}$\\uparrow', '0.623', '0.897', '0.820', '0.837', '0.842', '0.972\\bf', '0.963'],
...
ShapeNet_NonUniform_4096_Data = [
    ...
    ['$S_{cos}$\\uparrow', '0.303', '0.835', '0.807', '0.853\\underline', '0.837', '0.948\\bf'],
...
ShapeNet_NonUniform_2048_Data = [
    ...
    ['$S_{cos}$\\uparrow',  '0.312', '0.804\\underline', '0.787', '0.802', '0.798', '0.946\\bf'],
...
ShapeNet_NonUniform_1024_Data = [
    ...
    ['$S_{cos}$\\uparrow',  '0.320', '0.782', '0.798', '0.760', '0.632', '0.617', '0.899\\bf'],
...
Thingi10K_Data = [
    ...
    ['$S_{cos}$\\uparrow', '0.403', '0.882', '0.789', '0.783', '0.790', '0.823', '0.891'],
...
Thingi10K_Data = [
    ...
    ['$S_{cos}$\\uparrow', '0.403', '0.882\\underline', '0.789', '0.783', '0.823', '0.891\\bf'],
    ['NIC\\downarrow', '68.107', '34.144\\underline', '46.807', '41.533', '35.672', '27.146\\bf'],
]

SAMPLE_Data = [
    ['Method', 'L1-CD\\downarrow', 'L2-CD\\downarrow', 'FScore\\uparrow', '$D_H$\\downarrow', '$S_{cos}$\\uparrow', 'NIC\\downarrow'],
    ['w/o inversion', '5.909', '33.367', '0.981', '0.027', '0.961', '22.344'],
    ['w/o pre-sample', '5.762', '27.872', '0.996', '0.026', '0.978', '20.080'],
    ['MASH-Mesh', '5.450\\bf', '22.523\\bf', '0.997\\bf', '0.019\\bf', '0.980\\bf', '18.040\\bf'],
    ['MASH', '4.944\\bf', '2.268\\bf', '0.998\\bf', '0.013\\bf', '0.984\\bf', '13.346\\bf'],
]

SAMPLE_Data = SAMPLE_Data[:4]
SAMPLE_Data[3][0] = 'MASH'
