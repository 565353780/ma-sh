...
def findBestCases():
    ...
    save_result_folder_path = './output/metric_result_' + mode + '/'
    save_num = 10
    ...
    mash_mesh_folder_path = dataset_folder_path + 'Mash_Recon/'
    mash_mesh_type = '.ply'

    mash_pcd_folder_path = dataset_folder_path + 'MashPcd/'
    mash_pcd_type = '.ply'
    ...
    test = '/home/chli/chLi/Dataset/Mash_Recon/ShapeNet/03001627/1b5fc54e45c8768490ad276cd2af3a4.ply'
