...
class Convertor(object):
    def __init__(
        ...
        noise_label = 'Noise_' + str(self.gauss_sigma).replace('.', '-')

        self.sampled_pcd_folder_path = self.dataset_root_folder_path + "SampledPcd_Manifold_" + noise_label + "/"
        self.mash_folder_path = self.dataset_root_folder_path + "MashV4_" + noise_label + "/"
        self.tag_folder_path = self.dataset_root_folder_path + "Tag/MashV4_" + noise_label + "/"
        return
