...
class Convertor(object):
    def __init__(
        ...
        self.mash_folder_path = (
            self.dataset_root_folder_path + "MashV4_" + noise_label + "/"
        )
        self.mash_pcd_folder_path = (
            self.dataset_root_folder_path + "MashPcd_Manifold_" + noise_label + "/"
        )
        self.tag_folder_path = self.dataset_root_folder_path + "Tag/MashPcd_Manifold_" + noise_label + "/"
        return
